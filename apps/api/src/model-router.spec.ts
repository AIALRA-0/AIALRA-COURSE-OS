...
describe("generation harness", () => {
  it("loads editable prompt and schema files as one hashed snapshot", () => {
    ...
    expect(snapshot).toMatchObject({ id: "course-os-teaching", version: "2.4.58", taskContract: "GENERATE + TEACHING" });
    ...
    expect(snapshot.files.map((file) => file.path)).toEqual(["teaching-system-prompt.md", "teaching-user-prompt.md", "teaching-blueprint.md", "teaching-package.schema.json", "source-audit-prompt.md", "teaching-audit-prompt.md", "semantic-audit-prompt.md", "semantic-audit.schema.json", "policy-skill.md", "policy-format-rules.md", "policy-explanation-framework.md", "policy-formula-explanation.md", "page-plan-prompt.md", "planned-writing-prompt.md", "writing-format-contract.md", "apps/api/src/app.ts", "apps/api/src/generation-harness.ts", "apps/api/src/teaching-blueprint.ts", "apps/api/src/model-router.ts", "apps/api/src/teaching-patches.ts", "apps/api/src/model-usage-meter.ts", "apps/api/src/pricing.ts", "apps/api/src/teaching-plan.ts", "apps/api/src/planned-teaching.ts", "apps/api/src/generation-repair.ts", "packages/quality/src/index.ts", "packages/quality/src/presentation.ts"]);
